...
import LearnMorePage from './componets/learn';
      ...
      <div className="h-screen flex">
        <div className=" w-1/3 bg-black px-10 py-40">
          ...
          <div className=' flex px-11'>
            <a href='/learn' className="text-white bg-transparent border border-teal-600 rounded-xl px-3 py-2 hover:bg-teal-200 hover:text-gray-800">Learn more</a>
          </div>
        </div>
